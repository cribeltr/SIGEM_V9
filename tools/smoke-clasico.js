#!/usr/bin/env node
/****************************************************************************
 * SIGEM · Smoke test (humo) de la app CLÁSICA (app-clasico.html).
 * --------------------------------------------------------------------------
...
const html = fs.readFileSync(path.join(ROOT, 'app-clasico.html'), 'utf8');
...
setTimeout(() => {
  ...
  console.log(fail.length ? `\n*** SMOKE CLÁSICO: ${fail.length} fallo(s) ***` : '\n*** SMOKE CLÁSICO OK ***');
